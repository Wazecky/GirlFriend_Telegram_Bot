...
bot.command("menu", (ctx) => {
  ctx.telegram.sendMessage(
    ctx.chat.id,
    "Choose from the below menu how I can make your day better today! I'm here for you my love",
    {
      reply_markup: {
        inline_keyboard: [
          [
            { text: "Hot Pics", callback_data: "HOT_PICS" },
            { text: "Hot Videos", callback_data: "HOT_VIDEOS" },
          ],
          [{ text: "Affectionate GIFs", callback_data: "GIFS" }],
          [
            { text: "Voice Notes", callback_data: "VOICE" },
            { text: "Sweet Messages", callback_data: "SWEET" },
          ],
          [
            { text: "Love Quotes", callback_data: "QUOTES" },
            { text: "Date Ideas", callback_data: "DATES" },
            { text: "Love Poems", callback_data: "POETRY" },
          ],
          [
            { text: "Fun Jokes", callback_data: "JOKES" },
            { text: "Virtual Hug", callback_data: "HUG" },
            { text: "Goodnight Kiss", callback_data: "KISS" },
          ],
          [
            { text: "Compliments", callback_data: "COMPLIMENTS" },
            { text: "Relationship Advice", callback_data: "ADVICE" },
          ],
          [{ text: "Love Music Recommendations", callback_data: "MUSIC" }],
          [{ text: "Love Book Recommendations", callback_data: "BOOKS" }],
          [
            { text: "Movie Night", callback_data: "MOVIES" },
            { text: "Custom Messages", callback_data: "CUSTOM" },
          ],
        ],
      },
    }
...
bot.action("go-back", (ctx) => {
  ...
  ctx.telegram.sendMessage(
    ctx.chat.id,
    "What other category can I help you with?",
    {
      reply_markup: {
        inline_keyboard: [
          [
...
bot.action("COMPLIMENTS", async (ctx) => {
  ...
  ctx.telegram.sendMessage(
    ctx.chat.id,
    "_Here is a compliment for you handsome:_\n\n" + randomCompliment,
    {
      parse_mode: "Markdown",
      reply_markup: {
        inline_keyboard: [
...
bot.action("JOKES", async (ctx) => {
  ...
  ctx.telegram.sendMessage(
    ctx.chat.id,
    "_Here's a joke for you dear one:_\n\n" + randomLoveJoke,
    {
      parse_mode: "Markdown",
      reply_markup: {
        inline_keyboard: [
...
bot.action("ADVICE", async (ctx) => {
  ...
  const randomAdvice =
    relationshipAdvice[Math.floor(Math.random() * relationshipAdvice.length)];
...
bot.action("HUG", async (ctx) => {
  ...
  const randomHugMessage =
    virtualHugMessages[Math.floor(Math.random() * virtualHugMessages.length)];
...
bot.action("QUOTES", async (ctx) => {
  ...
  ctx.telegram.sendMessage(
    ctx.chat.id,
    "_Here is a love quote for you my dear:_\n\n" + randomLoveQuote,
    {
      parse_mode: "Markdown",
      reply_markup: {
        inline_keyboard: [
...
bot.action("MUSIC", async (ctx) => {
  ...
  ctx.telegram.sendMessage(
    ctx.chat.id,
    "_Here's a love music recommendation for you:_\n\n" +
...
bot.action("DATES", async (ctx) => {
  ...
  ctx.telegram.sendMessage(
    ctx.chat.id,
    "_Here's a romantic date idea for you both:_\n\n" + randomDateIdea,
    {
      parse_mode: "Markdown",
      reply_markup: {
        inline_keyboard: [
...
bot.action("POETRY", async (ctx) => {
  ...
  ctx.telegram.sendMessage(
    ctx.chat.id,
    "_Here's a beautiful love poem for you:_\n\n" + randomLovePoem,
    {
      parse_mode: "Markdown",
      reply_markup: {
        inline_keyboard: [
...
bot.action("BOOKS", async (ctx) => {
  ...
  ctx.telegram.sendMessage(
    ctx.chat.id,
    "_Here's a love book recommendation for you:_\n\n" + randomLoveBook,
    {
      parse_mode: "Markdown",
      reply_markup: {
        inline_keyboard: [
...
bot.action("MOVIES", async (ctx) => {
  ...
  ctx.telegram.sendMessage(
    ctx.chat.id,
    "_Here's a romantic movie recommendation for your movie night:_\n\n" +
      randomRomanticMovie,
    {
      parse_mode: "Markdown",
      reply_markup: {
...
bot.action("CUSTOM", async (ctx) => {
  ...
  ctx.telegram.sendMessage(
    ctx.chat.id,
    "You've chosen the 'Custom Messages' category. Please type any message, and I'll reply to you with love! 💕\n\nType 'MENU' to return to the main menu."
  );
});
...
bot.on("text", async (ctx) => {
  ...
  if (specificGreeting) {
    ...
    if (callingResponse) {
      ...
      let rawSentimentResponse =
        getrawPositiveSentimentResponse(sentimentIntent);
